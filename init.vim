...
vim.keymap.set('n', '<Leader>oFF', function() builtin.find_files({ hidden = true }) end, { noremap = true })
vim.keymap.set('n', '<Leader>oFI', function() builtin.find_files({ hidden = true, no_ignore = true }) end, { noremap = true })
